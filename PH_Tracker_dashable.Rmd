...
renderPlot({
  ...
  corpus <- corpus(df[df$from_user_screen_name %in% select,],docid_field = "tweet_id",text_field = "content")
  ...
  #set.seed(132)
  if (length(select)>1) {
    textplot_wordcloud(dfm, comparison = TRUE,random_color = FALSE, labelcolor = "gray45", labelsize = 2.5, labeloffset = 0, min_size = 0.5, max_size = 4,max_words = 200)
  }else {
      textplot_wordcloud(dfm, comparison = FALSE,random_color = FALSE, labelcolor = "gray45", labelsize = 2.5, labeloffset = 0, min_size = 0.5, max_size = 4,max_words = 200)
  }
...
Bigrams {data-orientation=rows data-icon="fa-bar-chart"}
=======================================================================
...
A *bigram* is a pair of consecutive words. This page shows the 20 most frequent bigrams used in candidates' tweets. For better readability, we have removed numbers, symbols, Twitter hashtags and handles, as well as URLs. We have also filtered common [stop words](https://en.wikipedia.org/wiki/Stop_words) in [English](https://gist.github.com/sebleier/554280) and [Tagalog](https://github.com/stopwords-iso/stopwords-tl).
...
The **Wordcloud** and **Bigrams** features allow you to compare across candidates with regard to frequent terms (single words and bigrams) used in their tweets. 
